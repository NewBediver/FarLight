...
namespace FarLight
{
		...
		: _rendererID(0)
	{
		...
		if (isCompiled == GL_FALSE)
		{
			...
			FL_CORE_ERROR("Vertex shader compilation error: {0}", vertexShader);
			FL_CORE_ERROR("{0}", infoLog.data());
			FL_CORE_ASSERT(false, "Critical error in vertex shader compilation!");
		...
		if (isCompiled == GL_FALSE)
		{
			...
			// Use the infoLog as you see fit.
			FL_CORE_ERROR("Fragment shader compilation error: {0}", fragmentShader);
			FL_CORE_ERROR("{0}", infoLog.data());
			FL_CORE_ASSERT(false, "Critical error in fragment shader compilation!");
