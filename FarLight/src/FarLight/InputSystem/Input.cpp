...
namespace FarLight
{
    ...
    bool Input::IsKeyPressed(KeyboardKeyCodes code) noexcept
    {
        ...
        int status = glfwGetKey(static_cast<GLFWwindow*>(Application::GetInstance().GetWindow()->GetNativeWindow().get()), key);
        return status == GLFW_PRESS || status == GLFW_REPEAT;
    }

    bool Input::IsMouseButtonPressed(MouseButtonCodes code) noexcept
    {
        FL_PROFILE_FUNCTION();

        int key = GetMouseButtonFromGLFW(code);
        int status = glfwGetMouseButton(static_cast<GLFWwindow*>(Application::GetInstance().GetWindow()->GetNativeWindow().get()), key);
    ...
    KeyboardKeyCodes Input::GetFLKeyboardKeyCode(int code) noexcept
    {
        switch (code)
        {
    ...
    MouseButtonCodes Input::GetFLMouseButtonCode(int code) noexcept
    {
        switch (code)
        {
    ...
    int Input::GetKeyboardKeyFromGLFW(KeyboardKeyCodes code) noexcept
    {
        switch (code)
        {
    ...
    int Input::GetMouseButtonFromGLFW(MouseButtonCodes code) noexcept
    {
        switch (code)
        {
