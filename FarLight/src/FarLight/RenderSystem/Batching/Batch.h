...
namespace FarLight
{
    ...
    public:
        ...
        constexpr bool IsEmpty() const noexcept { return m_Configuration.UsedVertexNumber == 0 && m_Configuration.UsedIndexNumber == 0; }
        constexpr bool HasFreeTextureSlots(unsigned numSlots = 0) const noexcept { return m_Configuration.UsedTextureSlots + numSlots < m_Configuration.MaxTextureSlots; }
        constexpr bool HasFreeVertexSlots(unsigned numVertices = 0) const noexcept { return m_Configuration.UsedVertexNumber + numVertices <= m_Configuration.MaxVertexNumber; }
        constexpr bool HasFreeIndexSlots(unsigned numIndices = 0) const noexcept { return  m_Configuration.UsedIndexNumber + numIndices <= m_Configuration.MaxIndexNumber; }
        constexpr const BatchConfiguration& GetConfiguration() const noexcept { return m_Configuration; }
